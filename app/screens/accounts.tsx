...
import AddAccountModal from "@/assets/components/dialogs/AddAccountModal"; // Adjust path if necessary
import { SVG_ICONS } from "@/assets/constants/icons";
import { supabase } from "@/lib/supabase";
import { Feather } from "@expo/vector-icons";
import React, { useEffect, useState } from "react";
...
export default function Accounts() {
  ...
  const handleModalSuccess = (newOfflineAccount?: any) => {
    if (newOfflineAccount) {
      setAccountsList((prev) => [...prev, newOfflineAccount]);
    } else {
      fetchAccounts();
    }
  };
